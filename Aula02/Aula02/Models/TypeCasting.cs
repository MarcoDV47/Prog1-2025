namespace Aula02.Models
{
    public class TypeCasting
    {
        ...
        public TypeCasting()
        {
            ...
            //(Significa que deixamos a conversão para o compilador)
            myLong = myInteger;

            //myInteger = myLong;
            //Neste caso, o long é muito grande para o int
            ...
            //É possível identificar qual é o tipo de
            //uma variável em tempo de execução
